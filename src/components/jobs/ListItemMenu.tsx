...
export default function ListItemMenu({ job }: IJob) {
    ...
    const showDeleteAlert = () => {
        Swal.fire({
            ...
            text: __('Are you sure to delete the job?', 'article-gen'),
    ...
    const changeJobStatus = () => {
        dispatch(jobStore)
            ...
            .then(() => {
                Swal.fire({
                    title: __('Job status updated', 'article-gen'),
                    text: __('Job has been updated successfully.', 'article-gen'),
                    icon: 'success',
                    toast: true,
                    position: 'bottom',
